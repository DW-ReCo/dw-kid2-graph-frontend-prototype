...
const DevPanel = () => {
  ...
  return (
    <>
      <div
        className={clsx(
          "bg-orange-100 flex-end min-h-screen p-2 ml-2 sticky max-h-screen top-0 right-0 overflow-y-scroll",
          showDevPanel ? "w-72" : "w-5",
        )}
      >
        <button
          className={clsx(
            "button-dev-panel-toggle text-white flex justify-center items-center",
