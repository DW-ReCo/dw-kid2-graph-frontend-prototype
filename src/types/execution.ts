...
import { DocumentId, DocumentPrototype, DocumentType } from "./document";
import { ExtractArgs, ExtractReturn, GenericService, UserAddService, YoutubeDownloadService } from "./service";
