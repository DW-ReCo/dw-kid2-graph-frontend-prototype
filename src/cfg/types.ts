...
export type LocalStorageConfigLoader = { _type: "local_storage_loader";
                                         key: string; }
export type ServerConfigLoader = { _type: "server_loader";
                                   endpoint: string;
                                   user: string;
                                   pass: string; }
...
export type LocalDbConfig = { _type: "local_db_config";
                              name: string; }
export type ServerDbConfig = { _type: "server_db_config";
                               name: string;
                               location: string; }
